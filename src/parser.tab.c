...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_IF_COND = 11,                   /* IF_COND  */
  YYSYMBOL_LBRACE = 12,                    /* LBRACE  */
  YYSYMBOL_RBRACE = 13,                    /* RBRACE  */
  YYSYMBOL_IDENTIFIER = 14,                /* IDENTIFIER  */
  YYSYMBOL_STRING = 15,                    /* STRING  */
  YYSYMBOL_TIME = 16,                      /* TIME  */
  YYSYMBOL_DAY_NAME = 17,                  /* DAY_NAME  */
  YYSYMBOL_SUCCESS = 18,                   /* SUCCESS  */
  YYSYMBOL_FAILURE = 19,                   /* FAILURE  */
  YYSYMBOL_YYACCEPT = 20,                  /* $accept  */
  YYSYMBOL_program = 21,                   /* program  */
  YYSYMBOL_task_list = 22,                 /* task_list  */
  YYSYMBOL_task_definition = 23,           /* task_definition  */
  YYSYMBOL_24_1 = 24,                      /* $@1  */
  YYSYMBOL_task_body = 25,                 /* task_body  */
  YYSYMBOL_run_stmt = 26,                  /* run_stmt  */
  YYSYMBOL_opt_schedule = 27,              /* opt_schedule  */
  YYSYMBOL_schedule_clause = 28,           /* schedule_clause  */
  YYSYMBOL_frequency = 29,                 /* frequency  */
  YYSYMBOL_opt_dependency = 30,            /* opt_dependency  */
  YYSYMBOL_dependency_clause = 31,         /* dependency_clause  */
  YYSYMBOL_opt_condition = 32,             /* opt_condition  */
...
{
       0,    85,    85,   105,   106,   111,   110,   126,   132,   143,
     144,   148,   158,   162,   172,   173,   177,   189,   190,   194,
     200
};
#endif
...
static const char *const yytname[] =
{
  ...
  "DAY", "WEEK", "ON", "AT", "AFTER", "IF_COND", "LBRACE", "RBRACE",
  "IDENTIFIER", "STRING", "TIME", "DAY_NAME", "SUCCESS", "FAILURE",
  "$accept", "program", "task_list", "task_definition", "$@1", "task_body",
  "run_stmt", "opt_schedule", "schedule_clause", "frequency",
  "opt_dependency", "dependency_clause", "opt_condition", "condition", YY_NULLPTR
};
...
{
       1,    -9,     6,     1,   -17,    -5,   -17,   -17,   -17,     4,
      -4,    -3,     7,   -17,   -17,    -6,    -1,   -17,   -17,     5,
       8,     0,   -17,   -17,    -2,     2,     9,   -17,   -17,   -16,
     -17,   -17,   -17,   -17
};
...
{
       0,     0,     0,     2,     3,     0,     1,     4,     5,     0,
       0,     0,    10,     8,     6,     0,    15,     9,    12,     0,
       0,     0,     7,    14,     0,     0,    18,    13,    11,     0,
      16,    19,    20,    17
};
...
{
      18,    19,    31,    32,     1,     5,     6,     8,    10,    21,
      14,    13,    15,    24,    26,    27,     7,    25,    28,     0,
      29
};

static const yytype_int8 yycheck[] =
{
       6,     7,    18,    19,     3,    14,     0,    12,     4,    10,
      13,    15,     5,     8,    14,    17,     3,     9,    16,    -1,
      11
};
...
{
       0,     3,    21,    22,    23,    14,     0,    23,    12,    24,
       4,    25,    26,    15,    13,     5,    27,    28,     6,     7,
      29,    10,    30,    31,     8,     9,    14,    17,    16,    11,
      32,    18,    19,    33
};
...
#line 111 "src/parser.y"
    {
        ...
        init_current_task();
        strncpy(current_task.name, (yyvsp[-1].sval), MAX_NAME_LEN - 1);
...
#line 1424 "src/parser.tab.c"
  ...
  case 6: /* task_definition: TASK IDENTIFIER LBRACE $@1 task_body RBRACE  */
...
#line 1433 "src/parser.tab.c"
  ...
  case 8: /* run_stmt: RUN STRING  */
#line 133 "src/parser.y"
    {
        strncpy(current_task.command, (yyvsp[0].sval), MAX_CMD_LEN - 1);
...
#line 1443 "src/parser.tab.c"
  ...
  case 11: /* schedule_clause: EVERY frequency AT TIME  */
#line 149 "src/parser.y"
    {
        current_task.has_schedule = 1;
        strncpy(current_task.schedule_time, (yyvsp[0].sval), 5);
...
#line 1462 "src/parser.tab.c"
  ...
  case 13: /* frequency: WEEK ON DAY_NAME  */
#line 163 "src/parser.y"
    {
        sprintf(current_task.schedule_freq, "EVERY WEEK ON %s", (yyvsp[0].sval));
        free((yyvsp[0].sval));
    }
#line 1471 "src/parser.tab.c"
    break;

  case 16: /* dependency_clause: AFTER IDENTIFIER opt_condition  */
#line 178 "src/parser.y"
    {
        current_task.has_dependency = 1;
        strncpy(current_task.depends_on, (yyvsp[-1].sval), MAX_NAME_LEN - 1);
